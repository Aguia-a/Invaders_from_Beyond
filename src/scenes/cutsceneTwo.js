export class CutsceneTwo extends Phaser.Scene {
  constructor() {
    super('CutsceneTwo');
  }
  ...
  create() {
    ...
    this.currentMessage =
      '[Comandante]\n' +
      'Identifique-se.\n' +
      'Esta é uma zona sob proteção da Federação da Terra.\n' +
      'Aproxime-se com intenções diplomáticas ou será considerado hostil.\n';
