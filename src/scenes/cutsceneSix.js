export class CutsceneSix extends Phaser.Scene {
  constructor() {
    super('CutsceneSix');
  }
  ...
  create() {
    ...
    'Sim.\n' +
    'Achar que a Terra iria se curvar...\n' +
    'Mas vocês não sabem o que é lutar por um lar.\n' +
    'Então eu vou mostrar.\n';

    this.currentIndex = 0;
    this.typeNextChar();

    // Inicia a próxima cena (CutsceneSeven) quando ENTER for pressionado
    this.input.keyboard.once('keydown-ENTER', () => {
      this.scene.start('CutsceneSeven');
    });
