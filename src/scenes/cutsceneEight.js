export class CutsceneEight extends Phaser.Scene {
  constructor() {
    super('CutsceneEight');
  }
  ...
  create() {
    ...
    'Então hora de mostrar a eles um pouco da determinação humana.\n' +
    'Hora de escolher uma nave e acabar com esses invasores.\n';
